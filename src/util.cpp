...
int nAnonymizeSpecTorAmount = 1000;
...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\SpecTor
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\SpecTor
    // Mac: ~/Library/Application Support/SpecTor
    // Unix: ~/.SpecTor
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "SpecTor";
#else
    fs::path pathRet;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "spector.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "spectord.pid"));
